...
class CountStableMatches():
	...
	def readFile(self):
		...
		with open(self.filename,"r") as inputFile:
			...
			self.count=math.factorial(self.n)
			...
			for n in range(len(self.allCombinations[b])):
				...
				if man_list[:women_index]:
					...
					for _ in range(women_index-1,-1,-1):
						...
						# Quick and easy testing trick instead of looking at a lot of data

						# if self.allCombinations[b]==(3,1,2,4) and n==0 and _==1:
						# 	print(w_suspect_index_in_wp)

						if w_suspect_index_in_wp<women_index:
